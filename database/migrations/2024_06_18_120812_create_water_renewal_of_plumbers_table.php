...
return new class extends Migration
{
    ...
    {
        Schema::create('water_renewal_of_plumbers', function (Blueprint $table) {
            $table->id();
            $table->integer('user_id')->nullable();
            $table->boolean('is_aapale_sarkar_payment_paid')->nullable();
            $table->string('plumber_license_no')->nullable();
            ...
            $table->string('educational_certificate_document')->nullable();
    ...
    {
        Schema::dropIfExists('water_renewal_of_plumbers');
    }
};
