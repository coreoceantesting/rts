...
return new class extends Migration
{
    ...
    {
        Schema::create('trade_renewal_license_permissions', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('old_permission_no')->nullable();
            $table->date('old_permission_date')->nullable();
    ...
    {
        Schema::dropIfExists('trade_renewal_license_permissions');
    }
};
