...
return new class extends Migration
{
    ...
    {
        Schema::create('trade_license_transfers', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('new_applicant_email')->nullable();
            $table->string('new_applicant_mobile_no')->nullable();
            $table->string('new_applicant_aadhar_no')->nullable();
            $table->text('address_of_new_applicant')->nullable();
    ...
    {
        Schema::dropIfExists('trade_license_transfers');
    }
};
