...
return new class extends Migration
{
    ...
    {
        Schema::create('fire_final_no_objections', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('city_structure')->nullable();
            ...
            $table->string('erection_of_fire_document')->nullable();
            $table->string('licensing_agency_document')->nullable();
            $table->string('guarantee_of_developer_document')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('fire_final_no_objections');
    }
};
