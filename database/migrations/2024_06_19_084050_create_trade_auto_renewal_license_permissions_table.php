...
return new class extends Migration
{
    ...
    {
        Schema::create('trade_auto_renewal_license_permissions', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('current_permission_expiry_date')->nullable();
            $table->date('current_permission_validity_date')->nullable();
            $table->date('business_start_date')->nullable();
            $table->string('business_or_trade_name')->nullable();
            $table->string('permission_detail')->nullable();
            $table->string('plot_no')->nullable();
            $table->string('description_of_trade_place')->nullable();
    ...
    {
        Schema::dropIfExists('trade_auto_renewal_license_permissions');
    }
};
