...
return new class extends Migration
{
    ...
    {
        Schema::create('trade_new_license_permissions', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('city_servye_no')->nullable();
    ...
    {
        Schema::dropIfExists('trade_new_license_permissions');
    }
};
