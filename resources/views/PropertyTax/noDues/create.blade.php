                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="applicant_name_eng" name="applicant_name_eng" type="text" placeholder="Enter Applicant Name">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="applicant_name_mar" name="applicant_name_mar" type="text" placeholder="Enter Applicant Name">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="applicant_full_address_eng" id="applicant_full_address_eng" cols="30" rows="2"  placeholder="Enter Applicant Address"></textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="applicant_full_address_mar" id="applicant_full_address_mar" cols="30" rows="2"  placeholder="Enter Applicant Address"></textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="annual_period" name="annual_period" type="text" placeholder="Enter Annual Period">
