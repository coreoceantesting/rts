            ...
            <div class="col-sm-12">
                <div class="card">
                    <form class="theme-form" name="addForm" id="addForm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <input type="hidden" name="id" id="editId" value="{{ $registrationofObjection->id }}">
                                <div class="col-md-4">
                                    <label class="col-form-label" for="upic_id">UPIC No<span class="text-danger">*</span></label>
                                    <input class="form-control" id="upic_id" name="upic_id" type="text" placeholder="Enter UPIC No" value="{{ $registrationofObjection->upic_id }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="applicant_full_name" name="applicant_full_name" type="text" placeholder="Enter Applicant Full Name" value="{{ $registrationofObjection->applicant_full_name }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="applicant_full_address" id="applicant_full_address" cols="30" rows="2"  placeholder="Enter Applicant Address" required>{{ $registrationofObjection->applicant_full_address }}</textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="applicant_mobile_no" name="applicant_mobile_no" type="number" placeholder="Enter Mobile Number" value="{{ $registrationofObjection->applicant_mobile_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="email_id" name="email_id" type="email" placeholder="Enter Email" value="{{ $registrationofObjection->email_id }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="aadhar_no" name="aadhar_no" type="number" placeholder="Enter Aadhar Card No" value="{{ $registrationofObjection->aadhar_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_owner_name" name="property_owner_name" type="text" placeholder="Enter Property Owner Name" value="{{ $registrationofObjection->property_owner_name }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="property_address" id="property_address" cols="30" rows="2"  placeholder="Enter Property Address" required>{{ $registrationofObjection->property_address }}</textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="zone" id="zone" required>
                                        ...
                                        <option {{ ($registrationofObjection->zone == "1") ? 'selected' : '' }} value="1">Prabhag1</option>
                                        <option {{ ($registrationofObjection->zone == "2") ? 'selected' : '' }} value="2">Prabhag2</option>
                                        <option {{ ($registrationofObjection->zone == "3") ? 'selected' : '' }} value="3">Prabhag3</option>
                                        <option {{ ($registrationofObjection->zone == "4") ? 'selected' : '' }} value="4">Prabhag4</option>
                                        <option {{ ($registrationofObjection->zone == "5") ? 'selected' : '' }} value="5">Prabhag5</option>
                                        <option {{ ($registrationofObjection->zone == "6") ? 'selected' : '' }} value="6">Prabhag6</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="ward_area" id="ward_area" required>
                                        ...
                                        <option {{ ($registrationofObjection->ward_area == "1") ? 'selected' : '' }} value="1">firstward</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="city_serve_number" name="city_serve_number" type="text" placeholder="City Serve Number" value="{{ $registrationofObjection->city_serve_number }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_no" name="property_no" type="text" placeholder="Enter Property Number" value="{{ $registrationofObjection->property_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="house_no" name="house_no" type="text" placeholder="Enter House Number" value="{{ $registrationofObjection->house_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="index_number" value="{{ $registrationofObjection->index_number }}" name="index_number" type="text" placeholder="Enter Index Number">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="property_usage" id="property_usage" required>
                                        ...
                                        <option {{ ($registrationofObjection->property_usage == "निवासी") ? 'selected' : '' }} value="निवासी">निवासी</option>
                                        <option {{ ($registrationofObjection->property_usage == "बिगर निवासी") ? 'selected' : '' }} value="बिगर निवासी">बिगर निवासी</option>
                                        <option {{ ($registrationofObjection->property_usage == "मिश्र") ? 'selected' : '' }} value="मिश्र">मिश्र</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="construction_type" id="construction_type" required>
                                        ...
                                        <option {{ ($registrationofObjection->construction_type == "सिमेंट कॉँक्रिट संरचना") ? 'selected' : '' }} value="सिमेंट कॉँक्रिट संरचना">सिमेंट कॉँक्रिट संरचना</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="is_construction_authorized" id="is_construction_authorized" required>
                                        ...
                                        <option {{ ($registrationofObjection->is_construction_authorized == "Yes") ? 'selected' : '' }} value="Yes">Yes</option>
                                        <option {{ ($registrationofObjection->is_construction_authorized == "No") ? 'selected' : '' }} value="No">No</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="is_there_water_connection" id="is_there_water_connection" required>
                                        <option value="">Select Option</option>
                                        <option {{ ($registrationofObjection->is_there_water_connection == "Yes") ? 'selected' : '' }} value="Yes">Yes</option>
                                        <option {{ ($registrationofObjection->is_there_water_connection == "No") ? 'selected' : '' }} value="No">No</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_area" name="property_area" type="text" placeholder="Enter Property Area" value="{{ $registrationofObjection->property_area }}" required>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var url = "{{ route('registration-of-objection.update', ":model_id") }}";
        $.ajax({
