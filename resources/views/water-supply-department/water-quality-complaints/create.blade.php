                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="water_connection_no" name="water_connection_no" type="text" required placeholder="Enter water connection no" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_owner_name" name="property_owner_name" type="text" required placeholder="Enter Property Owner Name">
