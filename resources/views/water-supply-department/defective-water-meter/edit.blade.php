                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="owner_name" name="owner_name" type="text" placeholder="Enter Name Of New Owner " value="{{ $data->owner_name }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="meter_reading" name="meter_reading" type="text" placeholder="Enter Meter Reading" value="{{ $data->meter_reading }}" required>
