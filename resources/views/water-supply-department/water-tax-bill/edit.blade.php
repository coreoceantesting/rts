                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="water_connection_no" name="water_connection_no" type="text" placeholder="Enter water connection no" value="{{ $data->water_connection_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_owner_name" name="property_owner_name" type="text" placeholder="Enter Property Owner Name" value="{{ $data->property_owner_name }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="city_serve_no" name="city_serve_no" type="text" placeholder="Enter City Serve No" value="{{ $data->city_serve_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_no" name="property_no" type="text" placeholder="Enter Property No" value="{{ $data->property_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="new_water_con" id="new_water_con" required>
                                        <option value="">Select option</option>
                                        @php
                                            $options = ["औध्योगिक व्यवसायासाठी", "घरघुती वापरा साठी", "बिगर घरघुती वापरासाठी", "वाणिज्य"];
                                        @endphp
                                        @foreach($options as $option)
                                        <option {{ $data->new_water_con == $option ? 'selected' : '' }} value="{{ $option }}">{{ $option }}</option>
                                        @endforeach
                                    </select>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var updateUrl = '{{ route("water-Tax-bill.update", $data->id) }}';
