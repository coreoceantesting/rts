                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_no" name="property_no" type="text" placeholder="Enter Property Number" value="{{ $data->property_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="no_of_user" name="no_of_user" type="number" placeholder="Enter Number Of Users For New Tap Connection" value="{{ $data->no_of_user }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="old_owner_name" name="old_owner_name" type="text" placeholder="Enter Name of old water connection Owenr" value="{{ $data->old_owner_name }}" required>
