                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="aadhar_no" name="aadhar_no" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" placeholder="Enter Aadhar Card No" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="date_of_water_bill" name="date_of_water_bill" type="date" required>
