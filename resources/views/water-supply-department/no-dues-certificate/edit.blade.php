                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="date_of_water_bill" name="date_of_water_bill" type="date" value="{{ $data->date_of_water_bill }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="tap_size" id="tap_size" required>
                                        ...
                                        @endphp
                                        @foreach($options as $option)
                                        <option {{ $data->tap_size == $option ? 'selected' : '' }} value="{{ $option }}">{{ $option }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" required name="current_existing_tap_type" id="current_existing_tap_type">
                                        <option value="">Select option</option>
                                        @php
                                            $options = ["बांधकाम", "औद्योगीक", "निवासी", "विशेष प्रवर्ग (शैक्षणिक संस्था,शासकीय,निमशासकीय कार्यालय,पथसंस्था,इतर)", "व्यावसायिक"];
                                        @endphp
                                        @foreach($options as $option)
                                        <option {{ $data->current_existing_tap_type == $option ? 'selected' : '' }} value="{{ $option }}">{{ $option }}</option>
                                        @endforeach
                                    </select>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var updateUrl = '{{ route("water-no-dues.update", $data->id) }}';
