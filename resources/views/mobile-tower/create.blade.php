                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4 mb-2">
                                <label class="col-form-label" for="pancard_number"> पैन कार्ड क्रमांक </label>
                                <input class="form-control" id="pancard_number" name="pancard_number" type="text" maxlength="10" minlength="10" placeholder="Enter Pancard Number">
                            ...
                            <div class="col-md-4">
                                <label class="col-form-label" for="email_id">ई-मेल</label>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="aadhar_number" name="aadhar_number" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" placeholder="Enter Aadhar Card No">
