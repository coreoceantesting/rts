                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="name" name="name" type="text" placeholder="Enter Shop name  in English" value="{{ old('name', $mobileTowerService->name) }}">
                                <span class="text-danger is-invalid name_err"></span>
                            </div>

                            <div class="col-md-4">
                                <label class="col-form-label" for="m_name"> दुकानाचे नाव मराठी<span class="text-danger">*</span></label>
                                <input class="form-control" id="m_name" name="m_name" type="text" placeholder="Enter Shop name Marathi" value="{{ old('m_name', $mobileTowerService->m_name) }}">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="pancard_number" name="pancard_number" type="text" maxlength="10" minlength="10" placeholder="Enter Pancard Number" value="{{ old('pancard_number', $mobileTowerService->pancard_number) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="mobile_no" name="mobile_no" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter Mobile Number" value="{{ old('mobile_no', $mobileTowerService->mobile_no) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" name="full_address" id="full_address" cols="30" rows="2" placeholder="Enter Applicant Address" type="text">{{ old('full_address', $mobileTowerService->full_address) }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="amount" name="amount" type="number" placeholder="Enter Applicant Name" value="{{ old('amount', $mobileTowerService->amount) }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                {{-- <div class="col-md-6 mb-3">
                                    ...
                                    <select name="nature_business_id" id="nature_business_id" class="form-select" required>
                                        <option value="" disabled selected> -- Select Business-- </option>
                                        @foreach ($nature_busis as $nature)
                                            <option value="{{ $nature->id }}" {{ $nature->id == $mobileTowerService->nature_business_id ? 'selected' : '' }}>{{ $nature->trade_type }}- {{ $nature->rate }} </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" name="trade" id="trade">
                                        ...
                                        <option value="ठोक" {{ $mobileTowerService->trade == 'ठोक' ? 'selected' : '' }}>ठोक</option>
                                        <option value="चिल्लर"{{ $mobileTowerService->trade == 'चिल्लर' ? 'selected' : '' }}>चिल्लर</option>
                                        <option value="ईतर" {{ $mobileTowerService->trade == 'ईतर' ? 'selected' : '' }}>ईतर</option>
                                        <option value="शोरुम"{{ $mobileTowerService->trade == 'शोरुम' ? 'selected' : '' }}>शोरुम</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="border rounded p-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="manufactured" id="manufactured" value="होय" {{ isset($mobileTowerService) && $mobileTowerService->manufactured == 'होय' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="border rounded p-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="business_premises" id="business_premises" value="होय" {{ isset($mobileTowerService) && $mobileTowerService->business_premises == 'होय' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="होय">होय</label>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="owner_place" name="owner_place" type="text" placeholder="Enter Name of the owner of the place" value="{{ old('owner_place', $mobileTowerService->owner_place) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="landlord_address" name="landlord_address" type="text" placeholder="Enter address" value="{{ old('landlord_address', $mobileTowerService->landlord_address) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="rental_agreement" name="rental_agreement" type="text" placeholder="Enter rental agreement" value="{{ old('rental_agreement', $mobileTowerService->rental_agreement) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="area" name="area" type="number" placeholder="Enter" value="{{ old('area', $mobileTowerService->area) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="border rounded p-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="noc_certificate" id="noc_certificate" value="होय" {{ isset($mobileTowerService) && $mobileTowerService->noc_certificate == 'होय' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="होय">होय</label>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="business_start" name="business_start" type="number" placeholder="Year of business start" value="{{ old('business_start', $mobileTowerService->business_start) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="registration_no" name="registration_no" type="number" placeholder="" value="{{ old('registration_no', $mobileTowerService->registration_no) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="food_drug" name="food_drug" type="text" placeholder="" value="{{ old('food_drug', $mobileTowerService->food_drug) }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input class="form-control" id="aadhar_number" name="aadhar_number" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" placeholder="Enter Aadhar Card No" value="{{ old('aadhar_number', $mobileTowerService->aadhar_number) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="director_name" name="director_name" type="text" placeholder="Enter Director Name" value="{{ old('director_name', $mobileTowerService->director_name) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="contact_no" name="contact_no" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter  Number" value="{{ old('contact_no', $mobileTowerService->contact_no) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="alternet_email" name="alternet_email" type="email" placeholder="Enter  Number" value="{{ old('alternet_email', $mobileTowerService->alternet_email) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="alternet_address" id="alternet_address" cols="30" rows="2" placeholder="Enter Address">{{ old('alternet_address', $mobileTowerService->alternet_address) }}</textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="border rounded p-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender" id="gender" value="स्त्री" {{ isset($mobileTowerService) && $mobileTowerService->gender == 'स्त्री' ? 'checked' : '' }}>
