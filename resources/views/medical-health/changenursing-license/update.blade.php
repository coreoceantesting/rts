                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="f_name" name="f_name" type="text" placeholder="Enter First Name" value="{{ $changeNursingLicense->f_name }}" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="m_name" name="m_name" type="text" placeholder="Enter Middle Name" value="{{ $changeNursingLicense->m_name }}" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="l_name" name="l_name" type="text" placeholder="Enter Last Name" value="{{ $changeNursingLicense->l_name }}" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="marathi_f_name" name="marathi_f_name" type="text" placeholder="नाव प्रविष्ट करा प्रथम" value="{{ $changeNursingLicense->marathi_f_name }}" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="marathi_m_name" name="marathi_m_name" type="text" placeholder="प्रविष्ट करा मधले नाव" value="{{ $changeNursingLicense->marathi_m_name }}" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="marathi_l_name" name="marathi_l_name" type="text" placeholder="आडनाव प्रविष्ट करा" value="{{ $changeNursingLicense->marathi_l_name }}" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="email" name="email" type="email" placeholder="Enter Email" value="{{ $changeNursingLicense->email }}" >
                                <span class="text-danger is-invalid email_err"></span>
                            </div>
                            <div class="col-md-5">
                                <label class="col-form-label" for="address"> Address <span class="text-danger">*</span></label>
                                <textarea class="form-control" name="address" id="address" cols="30" rows="2" placeholder="Enter Address" >{{ $changeNursingLicense->address }}</textarea>
                                <span class="text-danger is-invalid address_err"></span>
                            </div>

                            <div class="col-md-5">
                                <label class="col-form-label" for="marathi_address"> पत्ता (मराठी) <span class="text-danger">*</span></label>
                                <textarea class="form-control" name="marathi_address" id="marathi_address" cols="30" rows="2" placeholder="पत्ता" value="" >{{ $changeNursingLicense->marathi_address }}</textarea>
                            ...
                            <div class="col-md-5">
                                ...
                                <textarea class="form-control" name="purpose" id="purpose" cols="30" rows="2" placeholder="Enter purpose" value="" >{{ $changeNursingLicense->purpose }}</textarea>
                            ...
                            <div class="col-md-5">
                                ...
                                <textarea class="form-control" name="marathi_purpose" id="marathi_purpose" cols="30" rows="2" placeholder="उद्देश" value="" >{{ $changeNursingLicense->marathi_purpose }}</textarea>
