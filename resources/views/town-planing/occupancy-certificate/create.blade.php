<x-admin.layout>
    <x-slot name="title">To issue Occupancy Certificate/भोगवटा प्रमाणपत्र देणे</x-slot>
    <x-slot name="heading">To issue Occupancy Certificate/भोगवटा प्रमाणपत्र देणे</x-slot>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        $.ajax({
            url: '{{ route('town-occupancy-certificate.store') }}',
            type: 'POST',
            data: formdata,
            contentType: false,
            processData: false,
