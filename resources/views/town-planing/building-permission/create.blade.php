<x-admin.layout>
    <x-slot name="title">To issue building permission/बांधकाम परवानगी देणे</x-slot>
    <x-slot name="heading">To issue building permission/बांधकाम परवानगी देणे</x-slot>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        $.ajax({
            url: '{{ route('town-building-permission.store') }}',
            type: 'POST',
            data: formdata,
            contentType: false,
            processData: false,
