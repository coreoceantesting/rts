                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="pencard_num" name="pencard_num" type="text" maxlength="10" minlength="10" placeholder="Enter Pancard Number" value="{{ old('pencard_num', $renewLicenseMarriage->pencard_num) }}" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="mobile_num" name="mobile_num" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter Mobile Number"  value="{{ old('mobile_num', $renewLicenseMarriage->mobile_num) }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="aadhar_num" name="aadhar_num" type="text"  oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" placeholder="Enter Aadhar Card No" value="{{ old('aadhar_num', $renewLicenseMarriage->aadhar_num) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="contact_no" name="contact_no" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter  Number"  value="{{ old('contact_no', $renewLicenseMarriage->contact_no) }}">
