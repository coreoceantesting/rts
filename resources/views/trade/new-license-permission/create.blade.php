                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="city_servye_no" name="city_servye_no" type="text" placeholder="Enter City Servye Number" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_tax_no" name="property_tax_no" type="number" placeholder="Enter Property tax no" required>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("trade-new-license.store") }}',
            type: 'POST',
            data: formdata,
            contentType: false,
            processData: false,
