                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="plumber_license_no" name="plumber_license_no" type="text" placeholder="Enter Plumber License Number" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="aadhar_no" name="aadhar_no"  oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" type="text" placeholder="Enter Aadhar Number" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="training_institute_name" name="training_institute_name" type="text" placeholder="Enter Name of industrial training institute" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="year_of_passing" name="year_of_passing" type="text" placeholder="Enter Year Of Passing" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="remark" name="remark" type="text" placeholder="Enter Remark For Plumber License Renewal" required>
