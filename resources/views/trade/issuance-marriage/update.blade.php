                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="shop_name" name="shop_name" type="text" placeholder="Enter Shop name  in English" value="{{ old('shop_name', $issueLicenseMarriage->shop_name) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="marathi_shop_name" name="marathi_shop_name" type="text" placeholder="Enter Shop name Marathi" value="{{ old('marathi_shop_name', $issueLicenseMarriage->marathi_shop_name) }}">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="pencard_num" name="pencard_num" type="text" placeholder="Enter Pancard Number" value="{{ old('pencard_num', $issueLicenseMarriage->pencard_num) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="mobile_num" name="mobile_num" type="number" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter Mobile Number" value="{{ old('mobile_num', $issueLicenseMarriage->mobile_num) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="e_mail" name="e_mail" type="email" placeholder="Enter Email" value="{{ old('e_mail', $issueLicenseMarriage->e_mail) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" name="address" id="address" cols="30" rows="2" placeholder="Enter Applicant Address" type="text">{{ old('address', $issueLicenseMarriage->address) }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="zone" id="zone">
                                    ...
                                    @foreach ($zones as $zone)
                                        <option value="{{ $zone->name }}" @if ($zone->name == $issueLicenseMarriage->zone) selected @endif>{{ $zone->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="ward_area" id="ward_area">
                                    ...
                                    @foreach ($wards as $ward)
                                        <option @if ($issueLicenseMarriage->ward_area == $ward->name) selected @endif value="{{ $ward->name }}">{{ $ward->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="financial_year" name="financial_year">
                                    ...
                                    @foreach (range(1980, 2060) as $year)
                                        <option value="{{ $year }}" {{ $issueLicenseMarriage->financial_year == $year ? 'selected' : '' }}>
                                            {{ $year }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="to_year" name="to_year">
                                    <option value="">-- Select year --</option>
                                    @foreach (range(1980, 2060) as $year)
                                        <option value="{{ $year }}" {{ $issueLicenseMarriage->to_year == $year ? 'selected' : '' }}>
                                            {{ $year }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="amount" name="amount" type="number" placeholder="Enter Applicant Name" value="{{ old('amount', $issueLicenseMarriage->amount) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="border rounded p-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="manufactured" id="manufactured" value="होय" {{ isset($issueLicenseMarriage) && $issueLicenseMarriage->manufactured == 'होय' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="होय">होय</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="manufactured" id="manufactured" value="नाही" {{ isset($issueLicenseMarriage) && $issueLicenseMarriage->manufactured == 'नाही' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="border rounded p-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="business_premises" id="business_premises" value="होय" {{ isset($issueLicenseMarriage) && $issueLicenseMarriage->business_premises == 'होय' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="होय">होय</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="business_premises" id="business_premises" value="नाही" {{ isset($issueLicenseMarriage) && $issueLicenseMarriage->business_premises == 'नाही' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="नाही">नाही</label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="owner_place" name="owner_place" type="text" placeholder="Enter Name of the owner of the place" value="{{ old('owner_place', $issueLicenseMarriage->owner_place) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="address_owner_premises" name="address_owner_premises" type="text" placeholder="Enter Name of the owner of the place" value="{{ old('address_owner_premises', $issueLicenseMarriage->address_owner_premises) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="rental_agreement" name="rental_agreement" type="text" placeholder="Enter rental agreement" value="{{ old('rental_agreement', $issueLicenseMarriage->rental_agreement) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="area_used" name="area_used" type="number" placeholder="Enter" value="{{ old('area_used', $issueLicenseMarriage->area_used) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="border rounded p-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="noc_certificate" id="noc_certificate" value="होय" {{ isset($issueLicenseMarriage) && $issueLicenseMarriage->noc_certificate == 'होय' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="होय">होय</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="noc_certificate" id="noc_certificate" value="नाही" {{ isset($issueLicenseMarriage) && $issueLicenseMarriage->noc_certificate == 'नाही' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="नाही">नाही</label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="business_start" name="business_start" type="number" placeholder="Year of business start" value="{{ old('business_start', $issueLicenseMarriage->business_start) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="registration_no" name="registration_no" type="number" placeholder="" value="{{ old('registration_no', $issueLicenseMarriage->registration_no) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="food_drug" name="food_drug" type="text" placeholder="" value="{{ old('food_drug', $issueLicenseMarriage->food_drug) }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="aadhar_num" name="aadhar_num" type="number" placeholder="Enter Aadhar Card No" value="{{ old('aadhar_num', $issueLicenseMarriage->aadhar_num) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="director_name" name="director_name" type="text" placeholder="Enter Director Name" value="{{ old('director_name', $issueLicenseMarriage->director_name) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="contact_no" name="contact_no" type="number" placeholder="Enter  Number" value="{{ old('contact_no', $issueLicenseMarriage->contact_no) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="alternet_email" name="alternet_email" type="email" placeholder="Enter  Number" value="{{ old('alternet_email', $issueLicenseMarriage->alternet_email) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" name="alternet_address" id="alternet_address" cols="30" rows="2" placeholder="Enter Address">{{ old('alternet_address', $issueLicenseMarriage->alternet_address) }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="border rounded p-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="gender" value="स्त्री" {{ isset($issueLicenseMarriage) && $issueLicenseMarriage->gender == 'स्त्री' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="स्त्री">स्त्री</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="gender" value="पुरुष" {{ isset($issueLicenseMarriage) && $issueLicenseMarriage->gender == 'पुरुष' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="पुरुष">पुरुष</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="gender" value="ईतर" {{ isset($issueLicenseMarriage) && $issueLicenseMarriage->gender == 'ईतर' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="application_type" id="application_type">
                                    ...
                                    <option value="1" {{ $issueLicenseMarriage->application_type == '1' ? 'selected' : '' }}>परितक्ता</option>
                                    <option value="2" {{ $issueLicenseMarriage->application_type == '2' ? 'selected' : '' }}>प्रकल्पग्रस्त</option>
                                    <option value="3" {{ $issueLicenseMarriage->application_type == '3' ? 'selected' : '' }}>पूरग्रस्त</option>
                                    <option value="4" {{ $issueLicenseMarriage->application_type == '4' ? 'selected' : '' }}>अपंग</option>
                                    <option value="5" {{ $issueLicenseMarriage->application_type == '5' ? 'selected' : '' }}>विधवा </option>
                                    <option value="6" {{ $issueLicenseMarriage->application_type == '6' ? 'selected' : '' }}>सामान्य </option>
                                </select>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->director_image)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->director_image) }}" target="_blank">View Document</a></small>
                                @endif
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->other_documents)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->other_documents) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->fire_certificate)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->fire_certificate) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->market_license)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->market_license) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->food_drug_img)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->food_drug_img) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->shop_act)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->shop_act) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->pancard_image)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->pancard_image) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->aadharcard_image)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->aadharcard_image) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->tax_receipt_img)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->tax_receipt_img) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->interior_photo)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->interior_photo) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($issueLicenseMarriage->exterior_photo)
                                    <small><a href="{{ asset('storage/' . $issueLicenseMarriage->exterior_photo) }}" target="_blank">View Document</a></small>
                                @endif
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var updateUrl = '{{ route('trade-issuance-license-marriage.update', $issueLicenseMarriage->id) }}';
