                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="office_address" id="office_address" cols="30" rows="2" placeholder="Enter Office Address" required></textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="old_permission_no" name="old_permission_no" type="text" placeholder="Enter Old permission number" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="old_permission_date" name="old_permission_date" type="date" placeholder="Enter Old permission Date" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="area_size" name="area_size" type="number" placeholder="Enter New permission place area size (sqr mtr)" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-check d-flex align-items-start">
                                        ...
                                        <label class="form-check-label ms-2" required for="is_correct_info">
