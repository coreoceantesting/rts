                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="shop_name" name="shop_name" type="text" placeholder="Enter Shop name  in English"  value="{{ old('shop_name', $renewLicenseLoadging->shop_name) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="marathi_shop_name" name="marathi_shop_name" type="text" placeholder="Enter Shop name Marathi"  value="{{ old('marathi_shop_name', $renewLicenseLoadging->marathi_shop_name) }}">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="pencard_num" name="pencard_num" type="text" maxlength="10" minlength="10"  placeholder="Enter Pancard Number" value="{{ old('pencard_num', $renewLicenseLoadging->pencard_num) }}" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="mobile_num" name="mobile_num" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter Mobile Number"  value="{{ old('mobile_num', $renewLicenseLoadging->mobile_num) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" name="address" id="address" cols="30" rows="2" placeholder="Enter Applicant Address"  type="text">{{ old('address', $renewLicenseLoadging->address) }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="amount" name="amount" type="number" placeholder="Enter Applicant Name"  value="{{ old('amount', $renewLicenseLoadging->amount) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="border rounded p-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="manufactured" id="manufactured" value="होय" {{ isset($renewLicenseLoadging) && $renewLicenseLoadging->manufactured == 'होय' ? 'checked' : '' }} >
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="border rounded p-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="business_premises" id="business_premises" value="होय" {{ isset($renewLicenseLoadging) && $renewLicenseLoadging->business_premises == 'होय' ? 'checked' : '' }} >
                                        <label class="form-check-label" for="होय">होय</label>
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="owner_place" name="owner_place" type="text" placeholder="Enter Name of the owner of the place"  value="{{ old('owner_place', $renewLicenseLoadging->owner_place) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="address_owner_premises" name="address_owner_premises" type="text" placeholder="Enter Name of the owner of the place"  value="{{ old('address_owner_premises', $renewLicenseLoadging->address_owner_premises) }}">
                                <span class="text-danger is-invalid address_owner_premisese_err"></span>
                            </div>

                            <div class="col-md-4">
                                <label class="col-form-label" for="rental_agreement">भाडे करार कोणासोबत केलेले आहे<span class="text-danger">*</span></label>
                                <input class="form-control" id="rental_agreement" name="rental_agreement" type="text" placeholder="Enter rental agreement"  value="{{ old('rental_agreement', $renewLicenseLoadging->rental_agreement) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="area_used" name="area_used" type="number" placeholder="Enter"  value="{{ old('area_used', $renewLicenseLoadging->area_used) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="border rounded p-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="noc_certificate" id="noc_certificate" value="होय"  {{ isset($renewLicenseLoadging) && $renewLicenseLoadging->noc_certificate == 'होय' ? 'checked' : '' }} >
                                        <label class="form-check-label" for="होय">होय</label>
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="business_start" name="business_start" type="number" placeholder="Year of business start"  value="{{ old('business_start', $renewLicenseLoadging->business_start) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="registration_no" name="registration_no" type="number" placeholder=""  value="{{ old('registration_no', $renewLicenseLoadging->registration_no) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="food_drug" name="food_drug" type="text" placeholder=""  value="{{ old('food_drug', $renewLicenseLoadging->food_drug) }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="aadhar_num" name="aadhar_num" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" placeholder="Enter Aadhar Card No" value="{{ old('aadhar_num', $renewLicenseLoadging->aadhar_num) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="director_name" name="director_name" type="text" placeholder="Enter Director Name"  value="{{ old('director_name', $renewLicenseLoadging->director_name) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="contact_no" name="contact_no" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter  Number"  value="{{ old('contact_no', $renewLicenseLoadging->contact_no) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="alternet_email" name="alternet_email" type="email" placeholder="Enter  Number"  value="{{ old('alternet_email', $renewLicenseLoadging->alternet_email) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" name="alternet_address" id="alternet_address" cols="30" rows="2" placeholder="Enter Address" >{{ old('alternet_address', $renewLicenseLoadging->alternet_address) }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="border rounded p-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="gender" value="स्त्री"  {{ isset($renewLicenseLoadging) && $renewLicenseLoadging->gender == 'स्त्री' ? 'checked' : '' }} >
