                ...
                <form class="theme-form" name="addForm" id="addForm" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-5" style="margin:center">
                                    <label class="col-form-label" for="shop_name">
                                        Old License No<span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input class="form-control" id="shop_name" name="shop_name" type="text" placeholder="search" required>
...
<script>
    ...
    $("#addForm").submit(function(e) {
        ...
        $.ajax({
            url: '{{ route('trade-renew-license-loading.store') }}',
            type: 'POST',
            data: formdata,
            contentType: false,
            processData: false,
