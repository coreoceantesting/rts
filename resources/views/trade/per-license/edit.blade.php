                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="address" id="address" cols="30" rows="2"  placeholder="Enter Applicant's Full Address">{{ $data->address }}</textarea>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var updateUrl = '{{ route("trade-per-license.update", $data->id) }}';
