                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="office_address" id="office_address" cols="30" rows="2"  placeholder="Enter Applicant's Full Office Address" required>{{ $data->office_address }}</textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="aadhar_no" name="aadhar_no"  oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" type="text" placeholder="Enter Aadhar Card No" value="{{ $data->aadhar_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="current_permission_date" name="current_permission_date" type="date" placeholder="Enter Current Permission Date" value="{{ $data->current_permission_date }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="business_or_trade_name" name="business_or_trade_name" type="text" placeholder="Enter Business or trade_name" value="{{ $data->business_or_trade_name }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="area_size" name="area_size" type="text" placeholder="Enter New permission place area size (sqr mtr)" value="{{ $data->area_size }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="new_permission_details" name="new_permission_details" type="text" placeholder="Enter New permission details" value="{{ $data->new_permission_details }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="description_of_new_trade_place" name="description_of_new_trade_place" type="text" placeholder="Enter new trade place description" value="{{ $data->description_of_new_trade_place }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="new_applicant_name" name="new_applicant_name" type="text" placeholder="Enter Name of New Transferee Applicant" value="{{ $data->new_applicant_name }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="new_applicant_email" name="new_applicant_email" type="email" placeholder="Enter Email of New Transferee Applicant" value="{{ $data->new_applicant_email }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="new_applicant_mobile_no" name="new_applicant_mobile_no" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" type="text" placeholder="Enter New Transferee Mobile No " value="{{ $data->new_applicant_mobile_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="new_applicant_aadhar_no" name="new_applicant_aadhar_no" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" type="text" placeholder="Enter New transferee aadhar no" value="{{ $data->new_applicant_aadhar_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="address_of_new_applicant" id="address_of_new_applicant" cols="30" rows="2"  placeholder="Enter New transferee address of residence" required>{{ $data->address_of_new_applicant }}</textarea>
