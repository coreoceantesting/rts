                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="new_applicant_mobile_no" name="new_applicant_mobile_no" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" type="text" placeholder="Enter New Transferee Mobile No " value="{{ $data->new_applicant_mobile_no }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="new_applicant_aadhar_no" name="new_applicant_aadhar_no" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" type="text" placeholder="Enter New transferee aadhar no" value="{{ $data->new_applicant_aadhar_no }}">
