                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="mobile_no" name="mobile_no" type="number" placeholder="Enter Mobile Number" value="{{ $data->mobile_no }}" oninput="this.value = this.value.replace(/\D/g, '')" minlength="10" maxlength="10" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="aadhar_no" name="aadhar_no" type="text" placeholder="Enter Aadhar Card No" value="{{ $data->aadhar_no }}" oninput="this.value = this.value.replace(/\D/g, '')" minlength="12" maxlength="12" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="current_permission_expiry_date" name="current_permission_expiry_date" type="date" placeholder="Enter Current Permission Expiry Date" value="{{ $data->current_permission_expiry_date }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="current_permission_validity_date" name="current_permission_validity_date" type="date" placeholder="Enter current permission validity extended upto date" value="{{ $data->current_permission_validity_date }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="permission_detail" name="permission_detail" type="text" placeholder="Enter Permission details" value="{{ $data->permission_detail }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="description_of_trade_place" name="description_of_trade_place" type="text" placeholder="Enter trade place description" value="{{ $data->description_of_trade_place }}" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-check d-flex align-items-start">
                                        <input type="checkbox" required checked class="form-check-input mt-1" id="is_correct_info" name="is_correct_info" value="yes">
