                        ...
                        <div class="mb-3 row">
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="connection_type" id="connection_type">
                                        ...
                                        <option value="New Connection" {{ $drainageService->connection_type == 'New Connection' ? 'selected' : '' }}>New Connection (नवीन कनेक्शन)</option>
                                        <option value="Old Connection" {{ $drainageService->connection_type == 'Old Connection' ? 'selected' : '' }}>Old Connection (जुने कनेक्शन)</option>
                                        <option value="Re-Connection" {{ $drainageService->connection_type == 'Re-Connection' ? 'selected' : '' }}>Re-Connection (पुनर्रजोडणी)</option>
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="conn_property_type" id="conn_property_type">
                                        <option value="">Select</option>
                                        <option value="Residential" {{ $drainageService->conn_property_type == 'Residential' ? 'selected' : '' }}>Residential (निवासी)</option>
                                        <option value="Residential+ Commercial" {{ $drainageService->conn_property_type == 'Residential+ Commercial' ? 'selected' : '' }}>Residential+ Commercial (निवासी + व्यावसायिक)</option>
                                        <option value="Individual" {{ $drainageService->conn_property_type == 'Individual' ? 'selected' : '' }}>Individual (वैयक्तिक)</option>
                                        <option value="Educational" {{ $drainageService->conn_property_type == 'Educational' ? 'selected' : '' }}>Educational (शैक्षणिक)</option>
                                        <option value="Other" {{ $drainageService->conn_property_type == 'Other' ? 'selected' : '' }}>Other (इतर)</option>
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="application_category" id="application_category">
                                        <option value="">Select</option>
                                        <option value="Owner"  {{ $drainageService->application_category == 'Owner' ? 'selected' : '' }}>Owner (मालक)</option>
                                        <option value="Tenent" {{ $drainageService->application_category == 'Tenent' ? 'selected' : '' }}>Tenent (भाडेकरू)</option>
                                        <option value="GPA Holder" {{ $drainageService->application_category == 'GPA Holder' ? 'selected' : '' }}>GPA Holder (GPA धारक)</option>
                                        <option value="Other" {{ $drainageService->application_category == 'Other' ? 'selected' : '' }}>Other (इतर)</option>
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="title" id="title">
                                        <option value="">Select</option>
                                        <option value="Mr" {{ $drainageService->title == 'Mr' ? 'selected' : '' }}>Mr (श्री)</option>
                                        <option value="Mrs" {{ $drainageService->title == 'Mrs' ? 'selected' : '' }}>Mrs (सौ)</option>
                                        <option value="Ms" {{ $drainageService->title == 'Ms' ? 'selected' : '' }}>Ms (कु)</option>
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" id="f_name" name="f_name" type="text" placeholder="Enter First name" value="{{ old('f_name', $drainageService->f_name) }}">
                                    <span class="text-danger is-invalid f_name_err"></span>
                                </div>

                                <div class="col-md-3">
                                    <label class="col-form-label" for="m_name">Middle Name(मधले नाव )</label>
                                    <input class="form-control" id="m_name" name="m_name" type="text" placeholder="Enter Middle name" value="{{ old('m_name', $drainageService->m_name) }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" id="l_name" name="l_name" type="text" placeholder="Enter Last name" value="{{ old('l_name', $drainageService->l_name) }}">
                                ...
                                <div class="col-md-3">
                                    <label class="col-form-label" for="mobile_no">Mobile Number / मोबाईल नंबर<span class="text-danger">*</span><span class="text-danger">*</span></label>
                                    <input class="form-control" id="mobile_no" name="mobile_no" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter Mobile Number" value="{{ old('mobile_no', $drainageService->mobile_no) }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" id="email" name="email" type="email" placeholder="Enter Email" value="{{ old('email', $drainageService->email) }}">
                                    <span class="text-danger is-invalid email_err"></span>
                                </div>

                                <div class="col-md-3">
                                    <label class="col-form-label" for="aadhar_no">Aadhar No(आधार कार्ड)<span class="text-danger">*</span></label>
                                    <input class="form-control" id="aadhar_no" name="aadhar_no" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" placeholder="Enter Aadharcard Number" value="{{ old('aadhar_no', $drainageService->aadhar_no) }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="gender" id="gender">
                                        <option value="">Select</option>
                                        <option value="Male" {{ $drainageService->gender == 'Male' ? 'selected' : '' }}>Male(पुरुष)</option>
                                        <option value="Female" {{ $drainageService->gender == 'Female' ? 'selected' : '' }}>Female (स्त्रि)</option>
                                        <option value="Transgender" {{ $drainageService->gender == 'Transgender' ? 'selected' : '' }}>Transgender (ट्रान्सजेंडर)</option>
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" id="age" name="age" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="4" minlength="4" placeholder="" value="{{ old('age', $drainageService->age) }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <textarea class="form-control" name="address" id="address" cols="30" rows="2" placeholder=" " required>{{ old('address', $drainageService->address) }}</textarea>
                                    <span class="text-danger is-invalid address_err"></span>
                                </div>

                                <div class="col-md-3">
                                    <label class="col-form-label" for="landmark">Landmark (लँडमार्क )<span class="text-danger">*</span></label>
                                    <input class="form-control" id="landmark" name="landmark" type="text" placeholder="" value="{{ old('landmark', $drainageService->landmark) }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <textarea class="form-control" name="permanent_address" id="permanent_address" cols="30" rows="2" placeholder=" " required>{{ old('permanent_address', $drainageService->permanent_address) }}</textarea>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" id="city_name" name="city_name" type="text" placeholder="" value="{{ old('city_name', $drainageService->city_name) }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" id="pincode" name="pincode" type="number" placeholder="" value="{{ old('pincode', $drainageService->pincode) }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" id="state" name="state" type="text" placeholder="" value="{{ old('state', $drainageService->state) }}">
                            ...
                            <div class="mb-3 row">
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" id="csmc_prop_no" name="csmc_prop_no" type="text" placeholder="" value="{{ old('csmc_prop_no', $drainageService->csmc_prop_no) }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" id="cts_no" name="cts_no" type="number" placeholder="" value="{{ old('cts_no', $drainageService->cts_no) }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" name="Zone" id="zone" required>
                                            ...
                                            @foreach ($zones as $zone)
                                                <option  @if ($drainageService->zone == $zone->name) selected @endif value="{{ $zone->name }}">{{ $zone->name }}</option>
                                            @endforeach
                                        </select>
                                        <span class="text-danger is-invalid zone_err"></span>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="col-form-label" for="ward_no">
                                            Ward Area / प्रभाग क्षेत्र <span class="text-danger">*</span>
                                        </label>
                                        <select class="form-select @error('ward_no') is-invalid @enderror" name="ward_no" id="ward_no" required>
                                            <option value="">Select Ward Area</option>
                                            @foreach ($wards as $ward)
                                                <option value="{{ $ward->name }}"
                                                    {{ old('ward_no', $drainageService->ward_no ?? '') == $ward->name ? 'selected' : '' }}>
                                                    {{ $ward->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <textarea class="form-control" name="detail_address" id="detail_address" cols="30" rows="2" placeholder=" " required>{{ old('detail_address', $drainageService->detail_address) }}</textarea>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" id="lacality" name="lacality" type="text" placeholder="" value="{{ old('lacality', $drainageService->lacality) }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" id="longitude" name="longitude" type="text" placeholder="" value="{{ old('longitude', $drainageService->longitude) }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" id="lattitude" name="lattitude" type="text" placeholder="" value="{{ old('lattitude', $drainageService->lattitude) }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" id="near_landmark" name="near_landmark" type="text" placeholder="" value="{{ old('near_landmark', $drainageService->near_landmark) }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" id="property_city" name="property_city" type="text" placeholder="" value="{{ old('property_city', $drainageService->property_city) }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" id="property_state" name="property_state" type="text" placeholder="" value="{{ old('property_state', $drainageService->property_state) }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" id="property_pincode" name="property_pincode" type="number" placeholder="" value="{{ old('property_pincode', $drainageService->property_pincode) }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" id="place_business" name="place_business" type="number" placeholder="" value="{{ old('place_business', $drainageService->place_business) }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input class="form-control" id="sewer_diameter" name="sewer_diameter" type="number" placeholder="" value="{{ old('sewer_diameter', $drainageService->sewer_diameter) }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input class="form-control" id="branch_line" name="branch_line" type="number" placeholder="" value="{{ old('branch_line', $drainageService->branch_line) }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input class="form-control" id="diameter_connection" name="diameter_connection" type="number" placeholder="" value="{{ old('diameter_connection', $drainageService->diameter_connection) }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input class="form-control" id="sewer_line" name="sewer_line" type="number" placeholder="" value="{{ old('sewer_line', $drainageService->sewer_line) }}">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        <input class="form-control" id="csmc_connection" name="csmc_connection" type="number" placeholder="" value="{{ old('csmc_connection', $drainageService->csmc_connection) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" name="name_plumber" id="name_plumber">
                                            <option value="">Select</option>
                                            <option value="1" {{ $drainageService->name_plumber == '1' ? 'selected' : '' }}>Mr. Ashok Pandharinath Kharat</option>
                                            <option value="2" {{ $drainageService->name_plumber == '2' ? 'selected' : '' }}>Mr. Sheikh Afif Sheikh Abdul Rahman</option>
                                            <option value="3" {{ $drainageService->name_plumber == '3' ? 'selected' : '' }}>Mr. Laxman Limbaji Sathe</option>
                                        </select>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input class="form-control" id="property_tax" name="property_taxs" type="file">
                                    @if ($drainageService->property_tax)
                                    <small><a href="{{ asset('storage/' . $drainageService->property_tax) }}" target="_blank">View Document</a></small>
                                @endif
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input class="form-control" id="property_photo" name="property_photos" type="file" >
                                    @if ($drainageService->property_photo)
                                    <small><a href="{{ asset('storage/' . $drainageService->property_photo) }}" target="_blank">View Document</a></small>
                                @endif
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input class="form-control" id="water_tax" name="water_taxs" type="file">
                                    @if ($drainageService->water_tax)
                                    <small><a href="{{ asset('storage/' . $drainageService->water_tax) }}" target="_blank">View Document</a></small>
                                @endif
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    @if ($drainageService->passport_size_photo)
                                    <small><a href="{{ asset('storage/' . $drainageService->passport_size_photo) }}" target="_blank">View Document</a></small>
                                @endif
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    @if ($drainageService->aadharcard_photo)
                                    <small><a href="{{ asset('storage/' . $drainageService->aadharcard_photo) }}" target="_blank">View Document</a></small>
                                @endif
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var updateUrl = '{{ route('drainage.update', $drainageService->id) }}';
