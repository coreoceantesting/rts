                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="survey_no" name="survey_no" type="text" placeholder="Enter Survey No" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="applicant_mobile_no" name="applicant_mobile_no" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter Mobile Number" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="plot_no" name="plot_no" type="text" placeholder="Enter Plot No" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="road" name="road" type="text" placeholder="Enter Road" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="building_no" name="building_no" type="text" placeholder="Enter Building No" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="building_permission_no" name="building_permission_no" type="text" placeholder="Enter Building No" required>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("plinth-certificate.store") }}',
            type: 'POST',
            data: formdata,
            contentType: false,
            processData: false,
