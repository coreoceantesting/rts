                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="city_servye_no" name="city_servye_no" type="text" placeholder="Enter City Servye Number" value="{{ $data->city_servye_no }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_tax_no" name="property_tax_no" type="number" placeholder="Enter Property tax no" value="{{ $data->property_tax_no }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/Trade/NewLicense/' . $data->no_dues_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/Trade/NewLicense/' . $data->application_document) }}" target="_blank">View Document</a></small>
