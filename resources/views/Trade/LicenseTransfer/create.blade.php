                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="area_size" name="area_size" type="text" placeholder="Enter New permission place area size (sqr mtr)">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="new_applicant_name" name="new_applicant_name" type="text" placeholder="Enter Name of New Transferee Applicant">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="new_applicant_email" name="new_applicant_email" type="email" placeholder="Enter Email of New Transferee Applicant">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="address_of_new_applicant" id="address_of_new_applicant" cols="30" rows="2"  placeholder="Enter New transferee address of residence"></textarea>
