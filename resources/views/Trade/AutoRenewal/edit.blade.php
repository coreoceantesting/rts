                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/Trade/AutoRenewal/' . $data->application_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/Trade/AutoRenewal/' . $data->no_dues_document) }}" target="_blank">View Document</a></small>
