                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="current_permission_expiry_date" name="current_permission_expiry_date" type="date" placeholder="Enter Current Permission Expiry Date">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="current_permission_validity_date" name="current_permission_validity_date" type="date" placeholder="Enter Current permission validity extended upto date">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="permission_detail" name="permission_detail" type="text" placeholder="Enter Permission details">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="description_of_trade_place" name="description_of_trade_place" type="text" placeholder="Enter trade place description">
