                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="board_registration_document" name="board_registration_document" type="file">
                                    <small><a href="{{ asset('storage/Trade/NocForMandap/' . $data->board_registration_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="no_objection_document" name="no_objection_document" type="file">
                                    <small><a href="{{ asset('storage/Trade/NocForMandap/' . $data->no_objection_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="location_map_document" name="location_map_document" type="file">
                                    <small><a href="{{ asset('storage/Trade/NocForMandap/' . $data->location_map_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/Trade/NocForMandap/' . $data->fire_last_year_noObjection_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/Trade/NocForMandap/' . $data->traffic_last_year_noObjection_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="annexure" name="annexure" type="file">
                                    <small><a href="{{ asset('storage/Trade/NocForMandap/' . $data->annexure) }}" target="_blank">View Document</a></small>
