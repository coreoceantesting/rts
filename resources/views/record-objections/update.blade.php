                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="applicant_name" name="applicant_name" type="text" placeholder="Enter Applicant Name" value="{{ old('applicant_name', $recordObjectionService->applicant_name) }}" required>
                                <span class="text-danger is-invalid applicant_name_err"></span>
                            </div>

                            <div class="col-md-4">
                                <label class="col-form-label" for="email_id">Email ID / ई-मेल आयडी</label>
                                <input class="form-control" id="email_id" name="email_id" type="email" placeholder="Enter Email" value="{{ old('email_id', $recordObjectionService->email_id) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="mobile_no" name="mobile_no" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter Mobile Number"
                                    value="{{ old('mobile_no', $recordObjectionService->mobile_no) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="zone" id="zone" required>
                                    ...
                                    @foreach ($zones as $zone)
                                        <option @if ($recordObjectionService->zone == $zone->name) selected @endif value="{{ $zone->name }}">{{ $zone->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="ward_area" id="ward_area" required>
                                    ...
                                    @foreach ($wards as $ward)
                                        <option @if ($recordObjectionService->ward_area == $ward->name) selected @endif value="{{ $ward->name }}">{{ $ward->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="aadhar_number" name="aadhar_number" type="number" placeholder="Enter Aadhar Card No" value="{{ $recordObjectionService->aadhar_number ?? '' }}">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="pancard_number" name="pancard_number" type="number" placeholder="Enter Pancard Number" value="{{ $recordObjectionService->pancard_number ?? '' }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" name="full_address" id="full_address" cols="30" rows="2" placeholder="Enter Applicant Address" required>{{ $recordObjectionService->full_address ?? '' }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="business_name" name="business_name" type="text" placeholder="Enter Applicant Name" value="{{ $recordObjectionService->business_name ?? '' }}" required>
                                <span class="text-danger is-invalid applicant_name_err"></span>
                            </div>

                            <div class="col-md-4">
                                <label class="col-form-label" for="business_type">Business Type /व्यवसायाचा प्रकार</label>
                                <input class="form-control" id="business_type" name="business_type" type="text" placeholder="Enter Applicant Name" value="{{ $recordObjectionService->business_type ?? '' }}">
                                <span class="text-danger is-invalid applicant_name_err"></span>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="business" id="business">
                                    ...
                                    <option value="owner" {{ $recordObjectionService->business == 'owner' ? 'selected' : '' }}>Owner/मालक</option>
                                    <option value="partner" {{ $recordObjectionService->business == 'partner' ? 'selected' : '' }}>Partner/भागीदार</option>
                                    <option value="renter" {{ $recordObjectionService->business == 'renter' ? 'selected' : '' }}>Renter/भाडेकरी</option>
                                    <option value="rent" {{ $recordObjectionService->business == 'rent' ? 'selected' : '' }}>Rent/भाडे</option>
                                </select>
                                <span class="text-danger is-invalid zone_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="gst" name="gst" type="text" placeholder="Enter GST Number" value="{{ $recordObjectionService->gst ?? '' }}">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="area" name="area" type="number" placeholder="Enter Area By Meter" value="{{ $recordObjectionService->area ?? '' }}">
                                <span class="text-danger is-invalid aadhar_no_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                <label class="col-form-label" for="date_commencement"> Date of Commencement of Business / व्यवसाय सुरू केळ्याचा
                                    दिनांक </label>
                                <input class="form-control" id="date_commencement" name="date_commencement" type="date" placeholder="Select Flat Assesment Date" value="{{ $recordObjectionService->date_commencement ?? '' }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" name="address_est" id="address_est" cols="30" rows="2" placeholder="Enter Applicant Address" required>{{ $recordObjectionService->address_est ?? '' }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="advance_device" id="advance_device">
                                    ...
                                    <option value="yes" {{ $recordObjectionService->advance_device == 'yes' ? 'selected' : '' }}>YES</option>
                                    <option value="no" {{ $recordObjectionService->advance_device == 'no' ? 'selected' : '' }}>NO</option>
                                </select>
                                <span class="text-danger is-invalid zone_err"></span>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="first_aid" id="first_aid" value="{{ old('box') }}">
                                    <option value="">Select Devices</option>
                                    <option value="yes" {{ $recordObjectionService->first_aid == 'yes' ? 'selected' : '' }}>YES</option>
                                    <option value="no" {{ $recordObjectionService->first_aid == 'no' ? 'selected' : '' }}>NO</option>
                                </select>
                                <span class="text-danger is-invalid zone_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="numb_of_worker" name="numb_of_worker" type="number" placeholder="Enter Area By Meter" value="{{ $recordObjectionService->numb_of_worker ?? '' }}">
                                <span class="text-danger is-invalid aadhar_no_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="number_of_women" name="number_of_women" type="number" placeholder="Enter Area By Meter" value="{{ $recordObjectionService->number_of_women ?? '' }}">
                                <span class="text-danger is-invalid aadhar_no_err"></span>
                            </div>

                            <div class="col-md-4 mb-2">
                                <label class="col-form-label" for="number_of_men">Number of Men Class / पुरुष वर्ग संख्या </label>
                                <input class="form-control" id="number_of_men" name="number_of_men" type="number" placeholder="Enter Area By Meter" value="{{ $recordObjectionService->number_of_men ?? '' }}">
                                <span class="text-danger is-invalid aadhar_no_err"></span>
                            </div>

                            <div class="col-md-4 mb-2">
                                <label class="col-form-label" for="other">other / इतर </label>
                                <input class="form-control" id="other" name="other" type="number" placeholder="Enter Area By Meter" value="{{ $recordObjectionService->other ?? '' }}">
                                <span class="text-danger is-invalid aadhar_no_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->gumasta_certificate)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->gumasta_certificate) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->aadhar_pan)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->aadhar_pan) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->land_ownership)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->land_ownership) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->water_bill)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->water_bill) }}" target="_blank">View Document</a></small>
                                @endif
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->no_objection_certificate)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->no_objection_certificate) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->photo_of_place)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->photo_of_place) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->property_tax)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->property_tax) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->tenancy_agreement)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->tenancy_agreement) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->site_occupancy)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->site_occupancy) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->medical_certificate)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->medical_certificate) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->pest_control)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->pest_control) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->gst_registration)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->gst_registration) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->drug_administration)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->drug_administration) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->fire_rigade)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->fire_rigade) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                @if ($recordObjectionService->liquor_license)
                                    <small><a href="{{ asset('storage/' . $recordObjectionService->liquor_license) }}" target="_blank">View Document</a></small>
                                @endif
                                <span class="text-danger is-invalid upload_prescribed_formats_err"></span>
                            </div>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var updateUrl = '{{ route('record-objections.update', $recordObjectionService->id) }}';
