                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="aadhar_no" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" name="aadhar_no" type="text" placeholder="Enter Aadhar Card No" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="construction_type" required id="construction_type">
...
<script>
    $("#addForm").submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("issuance-of-property-tax.store") }}',
            type: 'POST',
            data: formdata,
            contentType: false,
            processData: false,
