<x-admin.layout>
    <x-slot name="title">Tax exemption for non-resident(रहिवासी नसलेल्या मालमत्ताना करात सूट मिळणे)</x-slot>
    <x-slot name="heading">Tax exemption for non-resident(रहिवासी नसलेल्या मालमत्ताना करात सूट मिळणे)</x-slot>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <form class="theme-form" name="addForm" id="addForm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <input type="hidden" name="id" value="{{ $taxExemptionNonResidentialProp->id }}" id="editId">
                                <div class="col-md-4">
                                    <label class="col-form-label" for="upic_id">UPIC No<span class="text-danger">*</span></label>
                                    <input class="form-control" id="upic_id" name="upic_id" type="text" placeholder="Enter UPIC No" value="{{ $taxExemptionNonResidentialProp->upic_id }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="applicant_full_name" name="applicant_full_name" type="text" placeholder="Enter Applicant Full Name" value="{{ $taxExemptionNonResidentialProp->applicant_full_name }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="applicant_full_address" id="applicant_full_address" cols="30" rows="2"  placeholder="Enter Applicant Address" required>{{ $taxExemptionNonResidentialProp->applicant_full_address }}</textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="applicant_mobile_no" name="applicant_mobile_no" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" type="text" placeholder="Enter Mobile Number" value="{{ $taxExemptionNonResidentialProp->applicant_mobile_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="email_id" name="email_id" type="email" placeholder="Enter Email" value="{{ $taxExemptionNonResidentialProp->email_id }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="aadhar_no" name="aadhar_no"  oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" type="text" placeholder="Enter Aadhar Card No" value="{{ $taxExemptionNonResidentialProp->aadhar_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_owner_name" name="property_owner_name" type="text" placeholder="Enter Property Owner Name" value="{{ $taxExemptionNonResidentialProp->property_owner_name }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="property_address" id="property_address" cols="30" rows="2"  placeholder="Enter Property Address" required>{{ $taxExemptionNonResidentialProp->property_address }}</textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="zone" required id="zone">
                                        ...
                                        <option {{ ($taxExemptionNonResidentialProp->zone == $zone->name) ? 'selected' : '' }} value="{{ $zone->name }}">{{ $zone->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" required name="ward_area" id="ward_area">
                                        ...
                                        <option {{ ($taxExemptionNonResidentialProp->ward_area == $ward->name) ? 'selected' : '' }} value="{{ $ward->name }}">{{ $ward->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="survey_number" name="survey_number" type="text" placeholder="Enter Survey Number" value="{{ $taxExemptionNonResidentialProp->survey_number }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_no" name="property_no" type="text" placeholder="Enter Property Number" value="{{ $taxExemptionNonResidentialProp->property_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_area" name="property_area" type="text" placeholder="Enter Property Area" value="{{ $taxExemptionNonResidentialProp->property_area }}" required>
                                ...
                                <div class="col-md-4">
                                    <label class="col-form-label" for="date_of_commencement">Date of Commencement of Use of Building / इमारतीचा वापर सुरू झाल्याची तारीख</label>
                                    <input class="form-control" id="date_of_commencement" name="date_of_commencement" type="date" value="{{ $taxExemptionNonResidentialProp->date_of_commencement }}" required>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var url = "{{ route('tax-exemption-non-resident.update', ":model_id") }}";
        $.ajax({
