                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="applicant_mobile_no" name="applicant_mobile_no" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" type="text" placeholder="Enter Mobile Number" value="{{ $registrationofObjection->applicant_mobile_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="aadhar_no" name="aadhar_no" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="12" minlength="12" type="text" placeholder="Enter Aadhar Card No" value="{{ $registrationofObjection->aadhar_no }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="zone" id="zone" required>
                                        ...
                                        <option {{ ($registrationofObjection->zone == $zone->name) ? 'selected' : '' }} value="{{ $zone->name }}">{{ $zone->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="ward_area" id="ward_area" required>
                                        ...
                                        <option {{ ($registrationofObjection->ward_area == $ward->name) ? 'selected' : '' }} value="{{ $ward->name }}">{{ $ward->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="property_usage" id="property_usage" required>
                                        ...
                                        <option {{ ($registrationofObjection->property_usage == $option) ? 'selected' : '' }} value="{{ $option }}">{{ $option }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="construction_type" id="construction_type" required>
                                        ...
                                        @endphp
                                        @foreach($options as $option)
                                        <option {{ ($registrationofObjection->construction_type == $option) ? 'selected' : '' }} value="{{ $option }}">{{ $option }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="is_construction_authorized" id="is_construction_authorized" required>
                                        ...
                                        @endphp
                                        @foreach($options as $option)
                                        <option {{ ($registrationofObjection->is_construction_authorized == $option) ? 'selected' : '' }} value="{{ $option }}">{{ $option }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="is_there_water_connection" id="is_there_water_connection" required>
                                        ...
                                        @endphp
                                        @foreach($options as $option)
                                        <option {{ ($registrationofObjection->is_there_water_connection == $option) ? 'selected' : '' }} value="{{ $option }}">{{ $option }}</option>
                                        @endforeach
                                    </select>
