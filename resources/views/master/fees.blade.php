            ...
            <form class="form-horizontal form-bordered" method="post" id="editForm">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-2">
                        ...
                        <div class="mb-3 row">
                            {{-- <div class="col-md-4">
                                <label class="col-form-label" for="service_name_id">Department Service Id <span class="text-danger">*</span></label>
                                <input class="form-control" id="add_service_name" name="service_name_id" type="number" readonly disabled>
                                <span class="text-danger is-invalid initial_err"></span>
                            </div> --}}
