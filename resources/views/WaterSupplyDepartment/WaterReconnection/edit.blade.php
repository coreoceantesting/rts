                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/Reconnection/' . $data->application_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/Reconnection/' . $data->nodues_document) }}" target="_blank">View Document</a></small>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var updateUrl = '{{ route("water-reconnection.update", $data->id) }}';
            ...
            success: function(data)
            {
                ...
                if (!data.error2)
                    swal("Successful!", data.success, "success")
                        .then((action) => {
                            window.location.href = '{{ route("water-reconnection.create") }}';
                        });
                else
