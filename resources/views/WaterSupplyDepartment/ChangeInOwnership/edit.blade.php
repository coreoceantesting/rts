                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="property_no" name="property_no" type="text" placeholder="Enter Property Number" value="{{ $data->property_no }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="old_owner_name" name="old_owner_name" type="text" placeholder="Enter Name of old water connection Owenr" value="{{ $data->old_owner_name }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/ChangeOwnership/' . $data->application_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/ChangeOwnership/' . $data->ownership_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/ChangeOwnership/' . $data->nodues_document) }}" target="_blank">View Document</a></small>
