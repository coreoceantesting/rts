                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="city_serve_no" name="city_serve_no" type="text" placeholder="Enter City Serve No" value="{{ $data->city_serve_no }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="new_water_con" id="new_water_con">
                                        ...
                                        <option value="1" {{ $data->new_water_con == 1 ? 'selected' : '' }}>औध्योगिक व्यवसायासाठी </option>
                                        <option value="2" {{ $data->new_water_con == 2 ? 'selected' : '' }}>घरघुती वापरा साठी</option>
                                        <option value="3" {{ $data->new_water_con == 3 ? 'selected' : '' }}>बिगर घरघुती वापरासाठी </option>
                                        <option value="4" {{ $data->new_water_con == 4 ? 'selected' : '' }}>वाणिज्य</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/TaxBill/' . $data->application_document) }}" target="_blank">View Document</a></small>
