<x-admin.layout>
    <x-slot name="title"> Disconnection Water Supply / तात्पुरते किंवा कायमस्वरूपी नळजोडणी खंडीत करणे</x-slot>
    <x-slot name="heading">Disconnection Water Supply / तात्पुरते किंवा कायमस्वरूपी नळजोडणी खंडीत करणे</x-slot>
        <!-- Add Form -->
                    ...
                    <form class="theme-form" name="addForm" id="addForm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    <label class="col-form-label" for="address">Property Full Address / मालमत्तेचा संपूर्ण पत्ता <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/DisconnectSupply/' . $data->application_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/DisconnectSupply/' . $data->nodues_document) }}" target="_blank">View Document</a></small>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var updateUrl = '{{ route("water-disconnect-supply.update", $data->id) }}';
