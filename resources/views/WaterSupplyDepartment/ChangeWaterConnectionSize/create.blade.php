                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="old_tap_size" id="old_tap_size" required>
                                        <option value="">Select option</option>
                                        @php
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="new_tap_size" id="new_tap_size" required>
                                        <option value="">Select option</option>
                                        @php
                                            $options = ["15mm", "20mm", "25mm", "40mm", "50mm", "80mm", "100mm", "150mm", "300mm"];
                                        @endphp
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="comment" name="comment" type="text" placeholder="Enter Comment" required>
