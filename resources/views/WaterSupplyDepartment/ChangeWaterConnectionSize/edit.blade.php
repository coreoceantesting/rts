                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="current_connection_is_authorized" id="current_connection_is_authorized">
                                        ...
                                        <option value="1" {{ $data->current_connection_is_authorized == 1 ? 'selected' : '' }}>Yes</option>
                                        <option value="2" {{ $data->current_connection_is_authorized == 2 ? 'selected' : '' }}>No</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="existing_connection_detail" id="existing_connection_detail">
                                        <option value="">Select option</option>
                                        <option value="1" {{ $data->existing_connection_detail == 1 ? 'selected' : '' }}>बांधकाम</option>
                                        <option value="2" {{ $data->existing_connection_detail == 2 ? 'selected' : '' }}>औद्योगीक</option>
                                        <option value="3" {{ $data->existing_connection_detail == 3 ? 'selected' : '' }}>निवासी</option>
                                        <option value="4" {{ $data->existing_connection_detail == 4 ? 'selected' : '' }}>विशेष प्रवर्ग (शैक्षणिक संस्था,शासकीय,निमशासकीय कार्यालय,पथसंस्था,इतर)</option>
                                        <option value="5" {{ $data->existing_connection_detail == 5 ? 'selected' : '' }}>व्यावसायिक अथवा वाणिज्य</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="old_tap_size" id="old_tap_size">
                                        <option value="">Select option</option>
                                        <option value="1" {{ $data->old_tap_size == 1 ? 'selected' : '' }}>100mm</option>
                                        <option value="2" {{ $data->old_tap_size == 2 ? 'selected' : '' }} >15mm</option>
                                        <option value="3" {{ $data->old_tap_size == 3 ? 'selected' : '' }}>150mm</option>
                                        <option value="4" {{ $data->old_tap_size == 4 ? 'selected' : '' }}>20mm</option>
                                        <option value="5" {{ $data->old_tap_size == 5 ? 'selected' : '' }}>25mm</option>
                                        <option value="6" {{ $data->old_tap_size == 6 ? 'selected' : '' }}>300mm</option>
                                        <option value="7" {{ $data->old_tap_size == 7 ? 'selected' : '' }}>40mm</option>
                                        <option value="8" {{ $data->old_tap_size == 8 ? 'selected' : '' }}>50mm</option>
                                        <option value="9" {{ $data->old_tap_size == 9 ? 'selected' : '' }}>80mm</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="new_tap_size" id="new_tap_size">
                                        <option value="">Select option</option>
                                        <option value="1"  {{ $data->new_tap_size == 1 ? 'selected' : '' }}>100mm</option>
                                        <option value="2" {{ $data->new_tap_size == 2 ? 'selected' : '' }}>15mm</option>
                                        <option value="3" {{ $data->new_tap_size == 3 ? 'selected' : '' }}>150mm</option>
                                        <option value="4" {{ $data->new_tap_size == 4 ? 'selected' : '' }}>20mm</option>
                                        <option value="5" {{ $data->new_tap_size == 5 ? 'selected' : '' }}>25mm</option>
                                        <option value="6" {{ $data->new_tap_size == 6 ? 'selected' : '' }}>300mm</option>
                                        <option value="7" {{ $data->new_tap_size == 7 ? 'selected' : '' }}>40mm</option>
                                        <option value="8" {{ $data->new_tap_size == 8 ? 'selected' : '' }}>50mm</option>
                                        <option value="9" {{ $data->new_tap_size == 9 ? 'selected' : '' }}>80mm</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="new_tap_connection" id="new_tap_connection">
                                        <option value="">Select option</option>
                                        <option value="1" {{ $data->new_tap_connection == 1 ? 'selected' : '' }}>औध्योगिक व्यवसायासाठी</option>
                                        <option value="2" {{ $data->new_tap_connection == 2 ? 'selected' : '' }}>घरघुती वापरा साठी</option>
                                        <option value="3" {{ $data->new_tap_connection == 3 ? 'selected' : '' }}>बिगर घरघुती वापरासाठी </option>
                                        <option value="4" {{ $data->new_tap_connection == 4 ? 'selected' : '' }}>वाणिज्य</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/ChangeConnectionSize/' . $data->application_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/ChangeConnectionSize/' . $data->nodues_document) }}" target="_blank">View Document</a></small>
