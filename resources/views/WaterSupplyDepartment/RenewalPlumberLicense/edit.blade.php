                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="plumber_license_no" name="plumber_license_no" type="text" placeholder="Enter Plumber License Number" value="{{ $data->plumber_license_no }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="have_experience" id="have_experience">
                                        ...
                                        <option value="1" {{ $data->have_experience == 1 ? 'selected' : '' }}>Yes</option>
                                        <option value="2" {{ $data->have_experience == 2 ? 'selected' : '' }}>No</option>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="remark" name="remark" type="text" placeholder="Enter Remark For Plumber License Renewal" value="{{ $data->remark }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/RenewalPlumber/' . $data->application_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/RenewalPlumber/' . $data->nodues_document) }}" target="_blank">View Document</a></small>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small><a href="{{ asset('storage/WaterDepartment/RenewalPlumber/' . $data->educational_certificate_document) }}" target="_blank">View Document</a></small>
