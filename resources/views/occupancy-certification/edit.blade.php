                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="applicant_mobile_no" name="applicant_mobile_no" value="{{ $occupancyCertificate->applicant_mobile_no }}" type="text" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="10" minlength="10" placeholder="Enter Mobile Number" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    @endif
                                    <input class="form-control" id="documents" name="documents" type="file" placeholder="Enter Document">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="commencement_certificate_no" name="commencement_certificate_no" value="{{ $occupancyCertificate->commencement_certificate_no }}" type="text" placeholder="Enter Building No" required>
