...
use App\Models\DivSubDivision;
use App\Models\ServiceCredential;

class DivSubDivisionService
{
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            $divsubdivision = DivSubDivision::find($id);

            // Handle file uploads and update original file names

            $divsubdivision->update($request->all());
