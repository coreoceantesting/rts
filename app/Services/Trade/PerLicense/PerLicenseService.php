    ...
    public function store($request)
    {
        ...
        try {
            ...
            if ($request->hasFile('application_document')) {
                $application_document = $request->application_document->store('Trade/PerLicense');
            }

            if ($request->hasFile('no_dues_document')) {
                $no_dues_document = $request->no_dues_document->store('Trade/PerLicense');
            }
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            if ($request->hasFile('application_document')) {
                ...
                $TradePerLicense->application_document = $request->application_document->store('Trade/PerLicense');
            }
            ...
            if ($request->hasFile('no_dues_document')) {
                ...
                $TradePerLicense->no_dues_document = $request->no_dues_document->store('Trade/PerLicense');
            }
