...
class LicenseCancellationService
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            $tradeLicenseCancellation = TradeLicenseCancellation::create($request->all());
            ...
            $data = $this->curlAPiService->sendPostRequestInObject($newData, config('rtsapiurl.trade') . 'SHELMicroService/SHELApi/ApleSarkarService/AddCancellationLiecenseFORPMC', '');
            ...
            if ($data['status'] == "200") {
                ...
                TradeLicenseCancellation::where('id', $tradeLicenseCancellation->id)->update([
