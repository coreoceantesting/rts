    ...
    public function store($request)
    {
        ...
        try {
            ...
            if ($request->hasFile('upload_prescribed_format')) {
                ...
                $fileone->storeAs('public/ConstructionDepartment/DrainageConnection', $upload_prescribed_format);
            }
            ...
            if ($request->hasFile('upload_no_dues_certificate')) {
                ...
                $filetwo->storeAs('public/ConstructionDepartment/DrainageConnection', $upload_no_dues_certificate);
            }

            if ($request->hasFile('upload_property_ownership')) {
                $filethree = $request->file('upload_property_ownership');
                $upload_property_ownership = time() . '_' . $filethree->getClientOriginalName();
                $filethree->storeAs('public/ConstructionDepartment/DrainageConnection', $upload_property_ownership);
            }
    ...
    public function update($request, $id)
    {
        ...
        try {
                ...
                if ($request->hasFile('upload_prescribed_format')) {
                    ...
                    $upload_prescribed_format = time() . '_' . $fileone->getClientOriginalName();
                    $fileone->storeAs('public/ConstructionDepartment/DrainageConnection', $upload_prescribed_format);
                    $ConstructionDrainageConnection->upload_prescribed_format = $upload_prescribed_format;
                }
                ...
                if ($request->hasFile('upload_no_dues_certificate')) {
                    ...
                    $upload_no_dues_certificate = time() . '_' . $filetwo->getClientOriginalName();
                    $filetwo->storeAs('public/ConstructionDepartment/DrainageConnection', $upload_no_dues_certificate);
                    $ConstructionDrainageConnection->upload_no_dues_certificate = $upload_no_dues_certificate;
                }
                ...
                if ($request->hasFile('upload_property_ownership')) {
                    ...
                    $upload_property_ownership = time() . '_' . $filethree->getClientOriginalName();
                    $filethree->storeAs('public/ConstructionDepartment/DrainageConnection', $upload_property_ownership);
                    $ConstructionDrainageConnection->upload_property_ownership = $upload_property_ownership;
                }
