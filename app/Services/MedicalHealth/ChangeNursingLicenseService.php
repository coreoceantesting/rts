...
class ChangeNursingLicenseService
{
    ...
    public function store($request)
    {
        ...
        $request['application_no'] = "CNL-" . time();


        $changeNursingLicense=ChangeNursingLicense::create($request->all());
    ...
    {
        return ChangeNursingLicense::find($id);
    }
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            $changeNursingLicense = ChangeNursingLicense::find($id);

            // Handle file uploads and update original file names

            $changeNursingLicense->update($request->all());
