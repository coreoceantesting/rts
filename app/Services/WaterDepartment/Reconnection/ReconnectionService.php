    ...
    public function store($request)
    {
        ...
        try {
            ...
            if ($request->hasFile('application_document')) {
                ...
                $fileone->storeAs('public/WaterDepartment/Reconnection', $application_document);
            }
            ...
            if ($request->hasFile('nodues_document')) {
                ...
                $filethree->storeAs('public/WaterDepartment/Reconnection', $nodues_document);
            }
    ...
    public function update($request, $id)
    {
        ...
        try {
                ...
                if ($request->hasFile('application_document')) {
                    ...
                    $application_document = time() . '_' . $fileone->getClientOriginalName();
                    $fileone->storeAs('public/WaterDepartment/Reconnection', $application_document);
                    $WaterReconnection->application_document = $application_document;
                }
                ...
                if ($request->hasFile('nodues_document')) {
                    ...
                    $nodues_document = time() . '_' . $filethree->getClientOriginalName();
                    $filethree->storeAs('public/WaterDepartment/Reconnection', $nodues_document);
                    $WaterReconnection->nodues_document = $nodues_document;
                }
