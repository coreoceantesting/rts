...
class WitnessInformationRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'second_witness_info_witness_photo.required' => 'Please upload witness photo',
            'second_witness_info_witness_photo.mimes' => 'Only png, jpg and jpeg type file supported',
            'second_witness_info_witness_photo.max' => "Max 400kb file suppoted",
            'second_witness_info_upload_signature.required' => 'Please upload witness photo',
            'second_witness_info_upload_signature.mimes' => 'Only png, jpg and jpeg type file supported',
            'second_witness_info_upload_signature.max' => "Max 400kb file suppoted",
            'second_witness_info_upload_document.required' => 'Please upload witness file',
            'second_witness_info_upload_document.mimes' => 'Only png, jpg, jpeg and pdf type file supported',
            'second_witness_info_upload_document.max' => "Max 2mb file suppoted",
            ...
            'third_witness_info_witness_photo.required' => 'Please upload witness photo',
            'third_witness_info_witness_photo.mimes' => 'Only png, jpg and jpeg type file supported',
            'third_witness_info_witness_photo.max' => "Max 400kb file suppoted",
            'third_witness_info_upload_signature.required' => 'Please upload witness photo',
            'third_witness_info_upload_signature.mimes' => 'Only png, jpg and jpeg type file supported',
            'third_witness_info_upload_signature.max' => "Max 400kb file suppoted",
            'third_witness_info_upload_document.required' => 'Please upload witness file',
            'third_witness_info_upload_document.mimes' => 'Only png, jpg, jpeg and pdf type file supported',
            'third_witness_info_upload_document.max' => "Max 2mb file suppoted",
